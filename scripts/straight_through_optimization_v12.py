"""
V12: Test with irrelevant seeds to see if we can move towards task-relevant prompts.
"""
...
def train_step(z, examples):
    """Simple training step, no PPL regularization."""
...
# ============================================================================
print("\n" + "=" * 70)
print("V12: Testing with various seeds including irrelevant ones")
print("=" * 70)
...
for seed_text, seed_type in seeds:
    print(f"\n{'=' * 60}")
    print(f"Seed ({seed_type}): '{seed_text}'")
    print("=" * 60)
    ...
    for step in range(40):
        ...
        print(f"[{step:2d}] loss={loss:.2f} z0={z0_acc:.0%} best={best_acc:.0%} | {prompt[:50]}")
